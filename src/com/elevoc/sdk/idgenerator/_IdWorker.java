...
public class _IdWorker {
    ...
    private _IdWorker(long workerId) {
...
//            logger.error(String.format("clock moved backwards.Refusing to generate id for %d milliseconds", (this.lastTimestamp - timestamp)));
    ...
    private static _IdWorker flowIdWorker = new _IdWorker(1);
    public static _IdWorker getFlowIdWorkerInstance() {
        return flowIdWorker;
    }
